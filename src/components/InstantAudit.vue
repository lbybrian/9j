...
//    },
    ...
    created() {
//  	console.log("详情页ID",this.$store.state.jk9.message)
//		  this.params.ruleId = this.objId
      this.getList(this.currentPage2, this.pageSize2, this.params,this.obj)
//    if (this.obj) {
//      this.params.id = this.obj.id
//      this.params.url = this.obj.url
//      console.log(this.obj.data===this.$store.state.jk9.data)
//      this.getList(this.currentPage2, this.pageSize2, this.params,this.obj)
//    }
    },
    mounted() {
    ...
    methods: {
      ...
      getList(page, pageSize, params,jk) {
        this.loading = true
        params.pageNum = page
        ...
        let r = jk;
          ...
          if (res.chartResultList!==null && res.chartResultList.length > 0) {
          	console.log('一查数据：',res)// 有图表数据
              ...
              option = {
                ...
                tooltip: {
                  ...
                  formatter: function (params) {
                  	console.log('wwwwwwwwwwwwwwwww',params)
									  console.log('先这样，再这样，明白没有？？',params);
									  var showHtm="FUCK?";
