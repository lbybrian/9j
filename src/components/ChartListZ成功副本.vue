...
//		  			console.log('赋值前11111111111',item)
		  			item.axisYArr=[]
		  			item.chartRuleId=qqq[i].analyRuleId
		  			item.axisX=qqq[i].xAxis
		  			item.yAxis=qqq[i].yAxisArr
		  			item.charType=qqq[i].chartType
		  			item.chartTemplateId=qqq[i].chartTemplateId
//		  			item.axisYArr=qqq[i].chartName
		  			aaa.push(item)
